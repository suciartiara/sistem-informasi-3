          ...
          <div className="contact-container">
            <IonRow className="first-row">
              ...
              <p className="kontak-message">
                Mari berkolaborasi bersama kami untuk memberdayakan petani dan
                generasi muda di sektor pertanian. Bersama kita ciptakan
                keberlanjutan, inovasi, dan kemajuan nyata bagi Bangsa
                Indonesia! Wisma 09, Jl. Letjen Z.T. Haryono No.kav 09,
                RT.09/RW.09, Tebet Bar., Jakarta, Kota Jakarta Selatan, Daerah
                Khusus Ibukota Jakarta 090909
              </p>
            </IonRow>
